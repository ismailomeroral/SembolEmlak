        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInRight">
                    <h3 class="column-title">Harika Bir Ekibiz</h3>
                    <p>
        ...
        <div class="container">
            ...
            <div class="text-center">
                <ul class="portfolio-filter">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:baglanti%>" SelectCommand="SELECT * FROM [kategori]"></asp:SqlDataSource>
                </ul>
                <!--/#portfolio-filter-->
            </div>
